...
/*                                                   +#+                      */
/*   Created: 2020/01/30 21:29:26 by krioliin       #+#    #+#                */
/*   Updated: 2020/01/30 21:30:19 by krioliin      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
bool		op_fork(t_cursor *cursor, t_vm *vm)
{
	...
	new = init_cursor(cursor->id, cursor->pos, cursor->opcode,
	vm->arena[(cursor->pos + 1) % MEM_SIZE]);
